...
<p>{ users[i] }</p>
<span>TGT Employee/span> </div>
<span class="tx-info tx-12"><span class="square-8 bg-info rounded-circle"></span> 0 </span> </div>
<!-- d-flex --> 
</a>`;



var bellNotificationDropdpwn = `
              <a href="" class="media-list-link read">
            <div class="media"> <img src="img/silhouette.png" alt="">
              <div class="media-body">
                ...
                <span>October 01, 2017 6:08pm</span> </div>
            </div>
            <!-- media --> 
            </a>`;
...
<div class="contact-person">
<p>${ users[i] }</p>
<span>TGT Employee</span>
</div>
</div>
</a>`;

var calandarEventNotificationCard = `
...
<label class="sidebar-label pd-x-10 mg-t-20 op-3">Navigation</label>
  <ul class="br-sideleft-menu">
    ...
    <li class="br-menu-item"> <a href="mailbox.html" class="br-menu-link"> <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i> <span class="menu-item-label">Mailbox</span> </a> </li>
    ...
    <!-- br-menu-item -->
    <li class="br-menu-item"> <a href="#" class="br-menu-link with-sub"> <i class="menu-item-icon ion-ios-redo-outline tx-24"></i> <span class="menu-item-label">Navigation</span> </a><!-- br-menu-link -->
      <ul class="br-menu-sub">
...
let list = _('liveUsers');
let link = contactListLink;
for(let i = 0;i < users.length; i++){
    list.innerHTML += contactListLink;
}
//}
