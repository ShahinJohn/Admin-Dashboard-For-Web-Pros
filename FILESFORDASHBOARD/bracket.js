...
$(document).ready(function () {
  ...
  $(document).on('click touchstart', function (e) {
    ...
    if($('body').hasClass('show-right')) {
      ...
      if (!targ) {
          targ = $(e.target).closest('.ui-datepicker-header').length;
          if(!targ) {
  ...
  var sec = date.getSeconds();
   $('#brDate').html(date.getFullYear()+":"+date.getDay()+":"+date.getMonth());
    $('#brTime').html(hour + " : " + min + " : " + sec);
}  
...
//  });
//    $('.br-switchbutton ').each(function(index, value) {
